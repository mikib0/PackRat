...
export default function DashboardScreen() {
  return (
    <>
      <LargeTitleHeader title="Dashboard" searchBar={{ iosHideWhenScrolling: true }} />
      <List
        ...
        <View className="flex-1 flex-row items-center justify-center gap-2 px-4">
          ...
          {info.item.badge && (
            <View className="bg-primary h-5 w-5 items-center justify-center rounded-full">
              <Text variant="footnote" className="text-primary-foreground font-bold leading-4">
                {info.item.badge}
              </Text>
            </View>
          )}
...
const DATA: MockData[] = [
  ...
  },
  {
    ...
    leftView: <IconView name="scale-balance" className="bg-blue-600" />,
    rightText: "Base: 8.2 lbs",
  },
  {
    id: "5",
    title: "Pack Categories",
    leftView: <IconView name="shape" className="bg-green-500" />,
    badge: 7,
  },
  "gap 2",
  {
    ...
    leftView: <IconView name="map-marker-path" className="bg-red-500" />,
    badge: 2,
  },
  {
    id: "7",
    title: "Weather Alerts",
    leftView: <IconView name="weather-lightning-rainy" className="bg-amber-500" />,
    rightText: "2 active",
  },
  {
    id: "8",
    title: "Trail Conditions",
    leftView: <IconView name="terrain" className="bg-violet-500" />,
  },
  "gap 3",
  {
    id: "9",
  ...
  },
  {
    id: "11",
    title: "Shared Packs",
    leftView: <IconView name="account-group" className="bg-sky-500" />,
  },
  {
    id: "12",
    title: "Pack Templates",
    leftView: <IconView name="content-copy" className="bg-sky-400" />,
